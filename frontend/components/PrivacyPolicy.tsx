    ...
    <PageContainer>
      <Stack>
        <Text>
          ...
          is part of Artingle OY. This privacy policy will explain how our organization
        ...
        <Text>
          ...
          <List pl="4">
            ...
            <ListItem>
              ...
              working with it. We will do our best to not collect any personal information
        ...
        <Text>
          <List pl="4">
            ...
            <ListItem>
              <ListIcon as={MdCheckCircle} color="green.500" />
              Email you with more information about our services that we think you might
              like by asking for your consent beforehand.
            </ListItem>
          </List>
        </Text>
        <Text>
        ...
        <Text>
          ...
          <Link href="https://www.digitalocean.com">DigitalOcean</Link> servers inside the
          EU.
        </Text>
        <Text>
          <Link href="/" aria-label="homepage">
          ...
          will keep your email address and feedback until you request to delete them,
          feedback data is anonymous and feedback providers can request deleting their
          feedback.
        </Text>
        <Heading as="h3" size="l">
          Marketing
        ...
        <Text>
          ...
          would like to send you information about products and services of ours that we
          think you might like.
        </Text>
        <Text>
          If you have agreed to receive marketing emails, you may always opt out at a
          later date.
        </Text>
        <Text>
          ...
          from contacting you for marketing purposes or giving your data to other members
          of Artingle OY.
        </Text>
        <Text>
          If you no longer wish to be contacted for marketing purposes, please contact us
          at our email: <Link href="mailto:support@miten.io">support@miten.io</Link>
        </Text>
        <Heading as="h3" size="l">
        ...
        <Text>
          ...
          &apos;s privacy policy, the data we hold on you, or you would like to exercise
